...
async function runScenarioHooks(hooks, world, fixtures) {
    let error;
...
async function runScenarioHook(hook, world, fixtures) {
...
function wrapHookFnWithTimeout(hook, world, fixtures) {
    ...
    return async () => {
        await (0, utils_1.callWithTimeout)(() => hook.fn.call(world, fixturesArg), timeout, getTimeoutMessage(hook));
    };
}
